...
void labirinto::CreditsScene::update(float deltaTime) {
    IScene::update(deltaTime);
}

void labirinto::CreditsScene::render() {
    IScene::render();
}

void labirinto::CreditsScene::initialize() {

    auto center = std::make_shared<entre_portais::GuiRectangle>("CenterText", "ui/credits_info.png");
...
void labirinto::CreditsScene::onKey(int key, int scancode, int action, int mods) {

}

void labirinto::CreditsScene::onMouseButton(int button, int action, int mods) {

}

void labirinto::CreditsScene::onExit() {

}

labirinto::CreditsScene::CreditsScene() : IScene("CreditsScene") {
