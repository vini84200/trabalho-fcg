...
void labirinto::LoseScene::update(float deltaTime) {
    IScene::update(deltaTime);
}

void labirinto::LoseScene::render() {
    IScene::render();
}

void labirinto::LoseScene::initialize() {

    auto center = std::make_shared<entre_portais::GuiRectangle>("CenterText", "ui/lose_info.png");
...
void labirinto::LoseScene::onKey(int key, int scancode, int action, int mods) {

}

void labirinto::LoseScene::onMouseButton(int button, int action, int mods) {

}

void labirinto::LoseScene::onExit() {

}

labirinto::LoseScene::LoseScene() : IScene("LoseScene") {
